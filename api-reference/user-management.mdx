...
|---|---|---|
| [**`/onboarduser`**](#post-onboarduser) | POST | Initiate BVN-based KYC and create a new user account. |
| [**`/onboardstatus`**](#post-onboardstatus) | POST | Check the current status of a pending onboarding request. |
| [**`/getuserdetails`**](#post-getuserdetails) | POST | Retrieve a user's full profile, wallets, and virtual accounts. |
| [**`/manageuserstatus`**](#post-manageuserstatus) | POST | Activate or deactivate a user account with an audit reason. |
| [**`/listfintechusers`**](#post-listfintechusers) | POST | Retrieve a paginated list of all users belonging to your fintech. |
