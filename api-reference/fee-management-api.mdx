...
|---|---|---|
| [`/getwithdrawalhistory`](#get-getwithdrawalhistory) | GET | Retrieve paginated history of all fintech fee withdrawals |
| [`/feewithdrawal`](#post-feewithdrawal) | POST | Request withdrawal of accumulated fees to a bank account |
| [`/getaccumulatedfees`](#get-getaccumulatedfees) | GET | Get a summary of accumulated fees and available withdrawal balance |
| [`/managefees`](#put-managefees) | PUT | Configure onramp and offramp fee percentages, caps, and toggles |
| [`/getfees`](#get-getfees) | GET | Retrieve the current fee configuration and example calculations |
| [`/fees/strails/preview`](#post-feesstrailspreview) | POST | Preview the Strails platform fee for a given amount and transaction type |
| [`/verifywithdrawal`](#post-verifywithdrawal) | POST | Check the status or outcome of a previously submitted withdrawal |
