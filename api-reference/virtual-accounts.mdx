...
|---|---|---|
| [**`/getfintechvirtualaccount`**](#get-getfintechvirtualaccount) | GET | Retrieve the NGN virtual account(s) assigned to your fintech at onboarding. |
| [**`/getvirtualaccount`**](#post-getvirtualaccount) | POST | Retrieve a specific user deposit virtual account including amounts and fee breakdown. |
