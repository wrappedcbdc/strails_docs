...
|---|---|---|---|
| [Get Fintech Virtual Account](#get-getfintechvirtualaccount) | `/getfintechvirtualaccount` | GET | Retrieve the NGN virtual account(s) assigned to your fintech at onboarding. |
| [Get Virtual Account](#post-getvirtualaccount) | `/getvirtualaccount` | POST | Retrieve a specific user deposit virtual account including amounts and fee breakdown. |

---

### GET /getfintechvirtualaccount {#get-getfintechvirtualaccount}
...
### POST /getvirtualaccount {#post-getvirtualaccount}
