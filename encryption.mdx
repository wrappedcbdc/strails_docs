---
title: "Strails Payload Encryption with X25519 and libsodium"
sidebarTitle: "Encryption"
description: "Learn how to encrypt Strails API request payloads and decrypt responses using X25519 key pairs and libsodium's sealed-box construction."
---
...
- **Test encryption in staging first.** Validate your encrypt/decrypt round-trip against `https://api.strails.io/v1/` before enabling it in production.

<Note>
  Contact [support@strails.co](mailto:support@strails.co) to receive the current Strails public key, register your own public key, or get help troubleshooting encryption issues.
</Note>
