...
<Note>
  **Token endpoints** (blockchain transfers, swaps, FX trades, asset withdrawals) require amounts in the **smallest unit** with 6 decimal places for cNGN, USDC, and USDT. To send 500 cNGN, pass `500000000` (500 x 10^6). DAI uses 18 decimals.
</Note>
